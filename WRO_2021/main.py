...
# gripper.moveUp(0)
# driveTrain.driveForward(-17, rc.speed)
...
# driveTrain.driveForward(-15, rc.speed)
# driveTrain.turnOnWheel(90, rc.turnOnWheel_speed, "right")
# driveTrain.driveForward(40, rc.speed)
# driveTrain.turnOnWheel(-90, rc.turnOnWheel_speed, "right")
...
# driveTrain.turnCircle(90, 17.5, rc.turnOnWheel_speed)

# Go and grab the sockets
driveTrain.turnCircle(90, 16.5, rc.turnOnWheel_speed)
lineFollower.followLine(43.4, rc.follow_speed, 3, 0, 0)
driveTrain.turnOnWheel(-90, rc.turnOnWheel_speed, "right")
gripper.both_close()
# driveTrain.driveForward(40, rc.speed)
lineFollower.followLine(20, rc.follow_speed-20, 2, 0, 0)
driveTrain.turnOnWheel(4, rc.turn_speed, "left")
driveTrain.driveForward(20, rc.follow_speed)
gripper.gripSockel()
driveTrain.driveForward(-25, rc.speed)
driveTrain.turnOnWheel(90, rc.turnOnWheel_speed, "right")
driveTrain.driveForward(25.7, rc.speed)
driveTrain.turnOnWheel(-90, rc.turnOnWheel_speed, "right")
# gripper.both_close(speed=20, angle=152)
gripper.both_close(speed=30, angle=152)
driveTrain.driveForward(23, rc.speed)
gripper.gripSockel(angle=140)
driveTrain.driveForward(-15, rc.speed)
...
driveTrain.driveForward(40, rc.speed)
driveTrain.turnOnWheel(-90, rc.turnOnWheel_speed, "right")
driveTrain.driveForward(17.5, rc.speed)
gripper.putInBattery(50)
driveTrain.driveForward(-15, rc.speed)
driveTrain.turnOnWheel(-90, rc.turnOnWheel_speed, "left")
driveTrain.driveForward(75.5, rc.speed)
driveTrain.turnOnPoint(-90, rc.speed)

lineFollower.followLine(30, rc.follow_speed, 3, 0, 0)
driveTrain.driveForward(-5, rc.speed)
driveTrain.driveForward(8.5, rc.speed)
gripper.both_close()
driveTrain.turnOnPoint(180, rc.turn_speed)
...
driveTrain.turnOnPoint(90, rc.turn_speed)
gripper.moveUp(0)
lineFollower.followLine(rc.StandardDistances["House"] + 6.5, rc.follow_speed, 3, 0, 0)
driveTrain.driveForward(rc.StandardDistances["House"] + 3, -rc.speed)
driveTrain.turnOnPoint(90, rc.turn_speed)
lineFollower.followLine(rc.CheckpointOnMainRoad["CP4"] - rc.CheckpointOnMainRoad["CP1.0"] - 3, rc.follow_speed, 3, 0, 0)
driveTrain.turnOnPoint(90, rc.turn_speed)
gripper.moveUp(1)
...
driveTrain.turnOnWheel(90, rc.turnOnWheel_speed, "left")
lineFollower.followLine(49, rc.follow_speed, 3, 0, 0)
driveTrain.turnOnWheel(92, rc.turnOnWheel_speed, "left")
lineFollower.followLine(rc.CheckpointOnMainRoad["CP6.0"] - 19, rc.follow_speed, 3, 0, 0)
driveTrain.turnOnWheel(-90, rc.turnOnWheel_speed, "right")
lineFollower.followLine(rc.StandardDistances["House"], rc.follow_speed, 3, 0, 0)
driveTrain.driveForward(-6, rc.speed)
...
driveTrain.driveForward(-17, rc.speed)
driveTrain.turnOnPoint(116, rc.turn_speed)
driveTrain.driveForward(200, rc.speed)
driveTrain.driveForward(-5, rc.speed)
driveTrain.turnOnPoint(-90, rc.turn_speed)
driveTrain.driveForward(15, rc.speed)