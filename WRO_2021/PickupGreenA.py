...
class pickupGreenA:
    ...
    def driveToPickupDestination(self, side):
        ...
        self.driveTrain.turnOnPoint(89 * ((side == "right") * 2 - 1), robotContainer.turn_speed)
        ...
        self.driveTrain.turnOnPoint(90 * ((side == "left") * 2 - 1), robotContainer.turn_speed)
        self.driveTrain.driveForward(4, robotContainer.getInstance().slow_speed)